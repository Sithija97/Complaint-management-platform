...
import { confirmAgreement } from "../../store/agreements/agreementSlice";
...
export const Agreement = () => {
  ...
  const handleAgreementSubmission = async (
    ...
    if (email === "") {
      ...
      const response = await dispatch(
        confirmAgreement({
          email,
          acceptance: acceptance === "1" ? true : false,
        })
      );
  ...
  return (
    ...
    >
      <form onSubmit={handleAgreementSubmission}>
        <Stack
          boxShadow={"2xl"}
        ...
        >
          ...
          <Stack align={"center"} spacing={2}>
            ...
            <Text fontSize={"md"} mt={5} color={"gray.500"}>
              Click{" "}
              <Link
                color={"blue.500"}
            ...
            <Text fontSize={"md"} color={"gray.500"}>
              Please review all the agreement terms before submit.
            </Text>
          </Stack>
          <RadioGroup onChange={setAcceptance} value={acceptance} w={"full"}>
            <Stack>
              ...
              <Radio value="2" size="md">
                <Text fontSize={"md"} color={"gray.500"}>
                  I do not accept the terms in the Agreement
                </Text>
              </Radio>
            </Stack>
          </RadioGroup>
